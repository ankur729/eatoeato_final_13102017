...
router
    ...
    .post('/send-verify-email-to-user', function (req, res, next) {
        ...
        var mailOptions = {
            ...
            subject: 'EatoEato-Email Verification', // Subject line
            text: 'Please Verify Your Email Account', // plain text body
            html: '<b> Please Click on Below Link to Verify your Account</b> <br><br> <a href="https://www.eatoeato.com:3000/#/verify-user-params/' + req.body.user_id + '/' + req.body.email + '">' + randomstring.generate({ length: 100, charset: 'alphabetic' }) + '</a>' // html body
        };
        ...
        db.user_infos.find({
            ...
            if (err || user == "") {
                ...
                var mailOptions = {
                    ...
                    html: '<b> Please Click on Below Link to Reset your Account Password</b> <br><br><br> <a href="https://eatoeato.com:3000/#/user_login' + user._id + '">' + randomValueHex(100) + '</a>' // html body
                };
...
router
    .post('/payu-wallet-process', function (req, res, next) {
        ...
        if (req.body.status == 'failure') {
            ...
            res.redirect('https://www.eatoeato.com:3000/#/my_wallet');
